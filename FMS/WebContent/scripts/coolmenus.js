...
oCMenu.offlineUrl="file:///C:\Program Files\Apache Group\Tomcat 4.1\webapps\eZest" //Value: "path_to_menu_file_offline/"
...
oCMenu.onlineUrl="http://localhost:8080/eZest/" //Value: "path_to_menu_file_online/"
...
*/
//Home
oCMenu.makeMenu('top','','<b>&nbsp;Home</b>','AdminMenu.jsp','Frame3')
//Units
oCMenu.makeMenu('top0','','<b>&nbsp;Units</b>','','')
    oCMenu.makeMenu('sub00','top0','&nbsp;View&nbsp;','ViewUnits.jsp','Frame3')
    oCMenu.makeMenu('sub01','top0','&nbsp;Add New&nbsp;','AddUnit0.jsp','Frame3')
    oCMenu.makeMenu('sub02','top0','&nbsp;Remove&nbsp;','DelUnit0.jsp','Frame3')
//Accommodation
oCMenu.makeMenu('top1','','<b>&nbsp;Accommodation</b>','','')
    oCMenu.makeMenu('sub10','top1','&nbsp;View&nbsp;','ViewLoc.jsp','Frame3')
    oCMenu.makeMenu('sub11','top1','&nbsp;Add&nbsp;','AddLoc0.jsp','Frame3')
    oCMenu.makeMenu('sub12','top1','&nbsp;Remove&nbsp;','DelLoc0.jsp','Frame3')
//Facilites
oCMenu.makeMenu('top2','','<b>&nbsp;Unit Facilites</b>','','')//,0,0,"","",'red','silver')
    oCMenu.makeMenu('sub20','top2','&nbsp;View&nbsp;','ViewFac.jsp','')
	oCMenu.makeMenu('sub21','top2','&nbsp;Add&nbsp;','AddFac0.jsp','')	
	oCMenu.makeMenu('sub20','top2','&nbsp;Assign&nbsp;','AssignFac0.jsp','')
	oCMenu.makeMenu('sub21','top2','&nbsp;Un Assign&nbsp;','UnAssignFac0.jsp','')	
//Booking
oCMenu.makeMenu('top3','','<b>&nbsp;Booking</b>','','')//,0,0,"","",'red','silver')
    oCMenu.makeMenu('sub30','top3','&nbsp;View Bookings&nbsp;','ViewAlloc.jsp','')
	oCMenu.makeMenu('sub31','top3','&nbsp;Allot Units&nbsp;','Allocate0.jsp','')	
	oCMenu.makeMenu('sub40','top4','&nbsp;Generate Bill&nbsp;','ViewGuests.jsp','')
//Guests
oCMenu.makeMenu('top4','','<b>&nbsp;Guest</b>','','')//,0,0,"","",'red','silver')
    oCMenu.makeMenu('sub40','top4','&nbsp;View Guests&nbsp;','ViewGuests.jsp','')
//Logout
oCMenu.makeMenu('top5','','<b>&nbsp;Logout</b>','Logout.jsp','Frame3')
