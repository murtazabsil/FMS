...
%>
	...
	<%  if(event != null && event.equals("1")){
		System.out.println(" in ifff after projectVO------------"+projectVO.getProjectName());
	%>
			...
			<TABLE id="project" width="30%" class="notepad" align="center">
				<TR class="row_title">
					<TH align="center" colspan=3><FONT SIZE="4" COLOR="#AA2504"
						face='verdana'>Edit Project</FONT>
					</TH>
				</TR>
				...
				<tr class=row_odd>
					...
					<TD colspan=2 align=left><Input type=text name='projectName'
						value="<%=projectVO.getProjectName() %>" maxlength="64">
					</TD>
				</tr>
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(projectVO.getProjectLob()+"")){
...
<!-- 							<OPTION Value="">HR</OPTION> -->
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(projectVO.getProjectAccount()+"")){
...
<!-- 							<OPTION Value="">BLUESTAR</OPTION> -->
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(projectVO.getProjectBaseCurrency()+"")){
...
if(str.substring(0,str.lastIndexOf("|")).equals(projectVO.getProjectPriority()+"")){
...
<!-- 							<OPTION Value="">PERFORMANCE</OPTION> -->
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(projectVO.getProjectStatus()+"")){
...
<!-- 							<OPTION Value="">Completed</OPTION> -->
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(projectVO.getProjectType()+"")){
...
<!-- 							<OPTION Value="">Enhancement</OPTION> -->
				...
				<tr class=row_odd>
					...
					<TD colspan=2 align=left><textarea name='projectDesc'
							ROWS="5
							COLS=" 50" value="<%=projectVO.getProjectDesc() %>" style="width: 360px;"></textarea>
					</TD>
...
%>
				<div id="pmdiv">
					<TABLE id="pm" width="30%" class="notepad" align="center">
						<TR class="row_title">
							<TH align="center" colspan=3><FONT SIZE="4" COLOR="#AA2504"
								face='verdana'>Edit Manager Profile</FONT>
							</TH>
						</TR>
						...
						<tr class=row_odd>
							...
							<TD colspan=2 align=left><Input type=text
								name="pmName" value='<%=managerVO.getManagerName() %>' maxlength="64"> </Input>
							</TD>
						</tr>
						<tr class=row_odd>
							<TD align="left" width="40%"><FONT SIZE="2" COLOR="#AA2504"
							...
							<TD colspan=2 align=left><Input type=text
								name="pmEmpId" value='<%=managerVO.getManagerEmpId() %>' maxlength="10"> </Input>
							</TD>
						</tr>
						<tr class=row_odd>
							<TD align="left" width="40%"><FONT SIZE="2" COLOR="#AA2504"
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(managerVO.getManagerLobId())){
...
<!-- 							<OPTION Value="">HR</OPTION> -->
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(managerVO.getManagerAccountId()+"")){
...
<!-- 							<OPTION Value="">BLUESTAR</OPTION> -->
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(managerVO.getManagerLocationId()+"")){
...
<!-- 							<OPTION Value="">UK</OPTION> -->
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(managerVO.getManagerCurrency()+"")){
...
<!-- 							<OPTION Value="">GBP</OPTION> -->
						...
						<tr class=row_odd>
							...
							<TD colspan='2' align='left'><textarea name='pmdesc' ROWS="5"
									COLS="50" value='<%=managerVO.getManagerDescrition() %>></textarea>'></textarea>
							</TD>
...
<% } else if(event != null && event.equals("3")){
							...
							<TABLE id="account" width="30%" class="notepad" align="center">
								<TR class="row_title">
									<TH align="center" colspan=3><FONT SIZE="4"
										COLOR="#AA2504" face='verdana'>Edit Account</FONT>
									</TH>
								</TR>
								...
								<tr class=row_odd>
									...
									<TD colspan=2 align=left><Input type=text
										name='accountName' value='<%=accountVO.getAccountName() %>' maxlength = '64'>
									</TD>
								</tr>
								<tr class=row_odd>
									<TD align="left" width="40%"><FONT SIZE="2"
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(accountVO.getAccountLob()+"")){
...
<!-- 							<OPTION Value="">HR</OPTION> -->
								...
								<tr class=row_odd>
									...
									<TD colspan=2 align=left><Input type=text
										name='accountClient' value='<%= accountVO.getAccountClient() %>' maxlength = '10'>
									</TD>
								</tr>
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(accountVO.getAccountLocation()+"")){
...
<!-- 							<OPTION Value="">UK</OPTION> -->
								...
								<tr class=row_odd>
									...
									<TD colspan=2 align=left><Input type=text
										name='accountHead'  value = "<%=accountVO.getAccountHead() %>"maxlength = '10'>
									</TD>
								</tr>
								...
								<tr class=row_odd>
									...
									<TD colspan ='2'  align='left'><textarea name='accountDescription' ROWS="5"
											COLS="50" value='<%=accountVO.getAccountDesc() %>'></textarea>
									</TD>
...
%>
								<div id="lobdiv">
									<TABLE id="lob" width="30%" class="notepad" align="center">
										<TR class="row_title">
									<TH align="center" colspan=3><FONT SIZE="4"
										COLOR="#AA2504" face='verdana'>Edit LOB</FONT>
									</TH>
								</TR>
								...
								<tr class=row_odd>
									...
									<TD colspan=2 align=left><Input type=text
										name='lobName' value='<%=lobVO.getLobName() %>' maxlength = '64'>
									</TD>
								</tr>
	...
	try{
		...
		for(String str :list){
			...
			if(str.substring(0,str.lastIndexOf("|")).equals(lobVO.getLobLocation()+"")){
...
<!-- 							<OPTION Value="">UK</OPTION> -->
								...
								<tr class=row_odd>
									...
									<TD colspan=2 align=left><Input type=text
										name='lobHead' value = '<%=lobVO.getLobHead() %>'  maxlength = '10'>
									</TD>
								</tr>
								...
								<tr class=row_odd>
									...
									<TD colspan ='2'  align='left'><textarea name='lobdesc' ROWS="5"
											COLS="50" value='<%=lobVO.getLobDesc() %>'></textarea>
									</TD>
