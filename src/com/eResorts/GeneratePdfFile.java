...
public class GeneratePdfFile {
	...
	private static Font smallBold = new Font(Font.FontFamily.TIMES_ROMAN, 8,
			Font.BOLD);
	Map inputToexcel;
	public GeneratePdfFile(Map inputToexcel, String inputFile) {
		// TODO Auto-generated constructor stub
		this.inputToexcel = inputToexcel;
...
//preface.add(new Paragraph("This document is a preliminary version and not subject to your license agreement or any other agreement with vogella.com ;-).",
	...
	private static void addContent(Document document, Map inputToexcel) throws DocumentException {
		Anchor anchor = new Anchor("First Chapter", catFont);
		anchor.setName("First Chapter");
