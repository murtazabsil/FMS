...
%>
<div id="project-list">
<div id="page-title"><h2>Lob List</h2></div>

<div style="position: absolute; margin-left: 70px; margin-top: 33px; z-index: 1000;">
<a href="AddLob.jsp">
<span style="background-color: #565656; padding: 7px; color: white;">Add New Lob</span>
</a></div>
...
<c:forEach items="${lobList}" var="element"> 
  <tr>
    ...
    <td><a href="<%=request.getContextPath()%>/Admin?action=edit&event=4&id=${element.lobId}">Edit</a></td>
  </tr>
</c:forEach>
</tbody>
</table>
...
<span style="font-weight: normal;"> Please keep mouse over Lob Name to get description.</span></div>
