...
%>
<div id="project-list">
<div id="page-title"><h2>User List</h2></div>

<div style="position: absolute; margin-left: 70px; margin-top: 33px; z-index: 1000;">
<a href="AddUser.jsp">
<span style="background-color: #565656; padding: 7px; color: white;">Add New User</span>
</a></div>
...
<c:forEach items="${userList}" var="element"> 
  <tr>
    ...
    <td><a href="<%=request.getContextPath()%>/Admin?action=edit&event=5&id=${element.regID}">Edit</a></td>
  </tr>
</c:forEach>
</tbody>
</table>
