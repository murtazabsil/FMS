...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/jquery-1.8.0.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/module.js"></script>
</head>
<body>
...
%>
<div id="project-list">
<div id="page-title"><h2>Manager List</h2></div>

<div style="position: absolute; margin-left: 70px; margin-top: 33px; z-index: 1000;">
<a href="AddManager.jsp">
<span style="background-color: #565656; padding: 7px; color: white;">Add New Manager</span>
</a></div>
...
<c:forEach items="${managerList}" var="element"> 
  <tr>
    ...
    <td><a href="<%=request.getContextPath()%>/Admin?action=edit&event=2&id=${element.managerId}">Edit</a></td>
  </tr>
</c:forEach>
</tbody>
</table>
...
<div style="clear: both; margin-left: 55px; margin-top: 120px;"><span style="color: red;">Note:</span>
<span style="font-weight: normal;"> Please keep mouse over Manager Name to get description.</span></div>
